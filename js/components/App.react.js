    ...
    const NavBar = (state.showNavBar && props.person) && (
      <div>
        ...
        onRequestChange={isDrawerOpen => this.setState({isDrawerOpen})}>
          ...
          <MenuItem onTouchTap={this.closeDrawer} onClick={_ => props.router.push('/emailstats')} rightIcon={<i className='fa fa-envelope' aria-hidden='true' />}>Sent Emails</MenuItem>
