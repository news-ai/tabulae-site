...
class Workspace extends Component {
  constructor(props) {
    ...
    const screenWidth = Math.max(document.documentElement.clientWidth, window.innerWidth || 900);
    ...
    window.onresize = _ => {
      ...
      // const screenHeight = Math.max(document.documentElement.clientHeight, window.innerHeight || 0);
      this.setState({screenWidth, width: screenWidth / 2 - 25});
    };
  }
  ...
  componentWillReceiveProps(nextProps) {
    if (this.props.params.templateId !== nextProps.params.templateId && nextProps.params.templateId !== 'new-template1') {
...
export default connect(
  (state, props) => ({
    ...
    template: props.params.templateId !== 'new-template1' && state.templateReducer[parseInt(props.params.templateId)],
  }),
  dispatch => ({
